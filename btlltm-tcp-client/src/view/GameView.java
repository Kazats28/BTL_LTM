...
public class GameView extends javax.swing.JFrame {
    ...
    public void showRoundResult(String winner, int actualPrice, int playerGuess, int competitorGuess, float playerScore, float competitorScore) {
        ...
        jLabel1.setText("Giá của sản phẩm: " + actualPrice + "K VND");
        jLabel2.setText("Giá đoán của bạn: " + playerGuess + "K VND");
        jLabel3.setText("Giá đoán của đối thủ: " + competitorGuess + "K VND");
    ...
    private void initComponents() {
        ...
        jLayeredPane1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(-60, 20, 660, 200));
